...
export const emergencyDrugsFixture = [
  ...
  { name: "Chlorphenamine",           indication: "After stabilisation only",      dose: "10 mg",             route: "IV or IM",                 notes: "NOT part of RCUK 2021 initial anaphylaxis management. Antihistamine for residual skin symptoms only, after adrenaline + ABCDE." },
  { name: "Hydrocortisone",           indication: "Adrenal crisis / severe asthma",dose: "200 mg",            route: "IV or IM",                 notes: "Steroids no longer routine in the RCUK 2021 anaphylaxis algorithm. Retain for adrenal crisis or life-threatening asthma." },
...
// mg per cartridge is based on the UK-standard 2.2 mL dental cartridge
// (concentration mg/mL x 2.2). Do not use 1.8 mL (US) cartridges here — it
// understates mg/cartridge and overstates the safe cartridge count.
export const laDrugsFixture = [
  { agent: "Lidocaine 2% + 1:80,000 adrenaline",    mgPerCart: 44, maxMgKg: 4.4, maxAbs: 300 },
  { agent: "Articaine 4% + 1:100,000 adrenaline",   mgPerCart: 88, maxMgKg: 7.0, maxAbs: 500 },
  { agent: "Articaine 4% + 1:200,000 adrenaline",   mgPerCart: 88, maxMgKg: 7.0, maxAbs: 500 },
  { agent: "Prilocaine 3% + felypressin",           mgPerCart: 66, maxMgKg: 6.0, maxAbs: 400 },
  { agent: "Mepivacaine 3% plain",                  mgPerCart: 66, maxMgKg: 4.4, maxAbs: 300 },
  { agent: "Bupivacaine 0.5% + 1:200,000 adrenaline", mgPerCart: 11, maxMgKg: 2.0, maxAbs: 150 },
];
...
export const safeguardingContactsFixture = [
  { role: "Practice Safeguarding Lead",         name: "Maya Manager",        phone: "020 7946 0000" },
