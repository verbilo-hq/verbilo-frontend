export const groupUpdatesFixture = [
  {
    id: 1,
    type: "video",
    tag: "Coffee With...",
    title: "Coffee with Dr. Callum Lead",
    desc: "Callum talks about transitioning from associate to partner, managing a mixed NHS/private list, and what she loves most about working at Dental Group Dental Group.",
    host: "Dr. Callum Lead",
    role: "Dentist · Southall",
    date: "2 May 2026",
    duration: "12 min",
    color: "#006974",
  ...
  },
  {
    ...
    type: "news",
    tag: "Group Update",
    title: "Dental Group Acquires Seventh Practice in Chichester",
    desc: "We're pleased to announce the acquisition of Chichester Dental Care, extending the Dental Group network further along the south coast. The practice joins the group from June 2026.",
    host: "Olivia Owner",
    role: "Founder & Group Clinical Director",
    date: "28 Apr 2026",
    color: "#9C27B0",
    body: `Dental Group is delighted to confirm the acquisition of Chichester Dental Care, a well-established mixed NHS and private practice in the heart of Chichester. The practice, which has served the local community for over 15 years, will join the Dental Group network from 1 June 2026.\n\nChichester Dental Care brings a skilled team of three associates and two dental nurses, a fully digitalised workflow including intraoral scanning, and an excellent CQC rating of Good across all five domains.\n\nThis acquisition marks a significant step in Dental Group's growth strategy, extending our footprint between our existing New Cross and Birmingham sites and bringing our total number of practices to seven. The existing team will be supported through our full onboarding programme, and all patients will continue to be seen without disruption to their care.\n\nFurther details on integration timelines and team introductions will follow over the coming weeks. We are thrilled to welcome the Chichester team to the Dental Group family.\n\n— Olivia Owner, Founder & Group Clinical Director`,
  },
  {
    id: 3,
    type: "video",
    ...
    desc: "Record patient satisfaction scores, three new associates, and ambitious plans for 2026. The leadership team reflects on a landmark year for Dental Group.",
    host: "Dental Group Leadership Team",
    role: "",
    date: "10 Jan 2026",
    duration: "8 min",
    color: "#E91E63",
...
export const tipsFixture = [
  { category: "Clinical",     tip: "The maximum safe dose of lidocaine 2% with 1:80,000 adrenaline is 4.4 mg/kg, up to 300 mg — about 6–7 UK 2.2 mL cartridges for a 70 kg adult. Always calculate before treating medically complex patients." },
...
export const defaultQuickLinksFixture = [
...
export const linkIconsFixture = [
  "external", "building", "award", "shield", "training", "barchart",
  "folder", "calendar", "mail", "zap", "target", "layers", "bookmark",
  "briefcase", "brain", "file", "monitor", "phone", "help", "clouddownload",
  "clock", "eye", "send", "checkcircle", "lightbulb", "star", "heart",
  "camera", "hash", "userplus", "usercheck", "checksquare", "dashboard",
  "clinical", "staff", "creditcard", "refresh", "cloud",
];

export const fallbackNewsFixture = [
  { tag: "Compliance", bg: "rgba(168,56,54,0.08)", color: "var(--error)",   icon: "shield",   title: "CQC — latest news and press releases",     desc: "Stay up to date with CQC inspections, new frameworks, and regulatory changes affecting dental practices.",                date: "", href: "https://www.cqc.org.uk/news" },
  { tag: "Regulatory", bg: "rgba(245,124,0,0.08)", color: "#F57C00",        icon: "award",    title: "GDC — news and updates",                   desc: "Fitness to practise decisions, standards updates, and registration news from the General Dental Council.",                date: "", href: "https://www.gdc-uk.org/news-blogs/news" },
  { tag: "Industry",   bg: "rgba(0,105,116,0.08)", color: "var(--primary)", icon: "building", title: "BDA — news for dental professionals",      desc: "Contract news, pay guidance, workforce updates, and clinical resources from the British Dental Association.",            date: "", href: "https://www.bda.org/news-and-opinion/" },
];
